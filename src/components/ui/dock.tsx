...
import { IconSmartHome, IconCategory2, IconCarouselHorizontal, IconSignature, IconNotebook, IconCalendarTime } from "@tabler/icons-react"
import Link from "next/link";

const tabs = [
    { id: 1, label: "Home", icon: <IconSmartHome className="h-full w-full" />, href: "/" },
    { id: 2, label: "Journey", icon: <IconCarouselHorizontal className="h-full w-full" />, href: "/journey"},
    { id: 3, label: "Projects", icon: <IconCategory2 className="h-full w-full" />, href: "/projects"},
    { id: 4, label: "Retrospective",icon: <IconNotebook className="h-full w-full" />, href: "/retros"},
    { id: 5, label: "Guestroom",icon: <IconSignature className="h-full w-full" />, href: "/guest"},
    { id: 6, label: "Book a call",icon: <IconCalendarTime className="h-full w-full" />, href: "https://cal.com/hola-razan"},
];
