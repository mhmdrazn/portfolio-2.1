  ...
  return (
    ...
    >
      <motion.div
        ...
        className="absolute left-[2px] top-[2px] z-10 flex h-[36px] items-center justify-center -space-x-2 rounded-lg bg-primary bg-[linear-gradient(_180deg,background] dark:bg-[linear-gradient(_180deg,rgba(0,0,0,0.24)_0%,rgba(255,255,255,0)_67.51%_)]"
      >
