    ...
    return (
        <footer className='flex w-full px-4 py-12 md:px-8 lg:px-16 justify-center items-center bg-dark'>
            <div className='flex flex-col max-w-3xl w-full gap-4 justify-between'>
                ...
                <div className='flex flex-col md:flex-row gap-8 justify-center items-center md:justify-between md:items-start'>        
                    <div className='flex flex-col justify-around items-start w-fit md:gap-20'>
                        <p className='text-sm text-white/50 md:text-left text-center'>
                            Design, Develop, and Delight <br/>everyone with Ideas
                        </p>
                        <p className='hidden md:block font-thin text-sm pt-2 text-center md:text-left'>
                    ...
                    <div className='flex flex-col md:flex-row justify-center gap-8 md:gap-12'>
                        ...
                        <div className='flex flex-col justify-center items-center md:justify-end md:items-end gap-2'>
                            ...
                            <div className='flex flex-col justify-center items-center md:justify-end md:items-end gap-1'>
                                ...
                                <Link href={"/projects"} className="anim text-sm text-white/40 hover:text-white">
                                    My <span className='text-white/60'><i>Uneg-Uneg</i></span>
                                </Link>
                            </div>
                        </div>
                    </div>
