    ...
    return (
        <main className="flex flex-col min-h-screen w-full pb-6 md:pb-12 lg:pb-20 justify-start items-center gap-4">
            <div className="w-full h-96 object-cover overflow-hidden">
                <Image src="/itsm/week1-itsm.jpg" alt="week1-banner" width={1920} height={384} />
            </div>
            <Template>
                ...
                <Template>
                    ...
                    <Section>
                        <h3 className="font-normal text-sm">Service Management as a Capability</h3>
                        <Paragraph
                            text={
                            ...
                            <table className="min-w-full border border-gray-300 text-xs">
                                <thead>
                                    <tr className="bg-gray-100">
                                        ...
                                        <th className="border px-4 py-2 text-center">Service</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="border px-4 py-2">
                                            Tangible results or standalone packages (e.g., software
                                    ...
                                    <tr>
                                        ...
                                        <td className="border px-4 py-2">
                                            Outcomes, experiences, and benefits created together.
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td className="border px-4 py-2">
                                            Repeated and continuous, requiring ongoing engagement.
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <Section>
                        ...
                        <div className="flex flex-col">
                            ...
                            <ul className="list-disc pl-6 mt-2 text-sm">
                                <li className="anim text-background/70 hover:text-background text-xs md:text-sm w-fit text-justify">
                                    <strong>Utility</strong> is about whether a service does what it
                                    is supposed to do, the core function, or &quot;fit for
                                    purpose&quot;.
                                </li>
                                <li className="anim text-background/70 hover:text-background text-xs md:text-sm w-fit text-justify">
                                    <strong>Warranty</strong> is about how well the service
                                    performs, whether it is reliable, secure, and available, or fit
                                    for use.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <ul className="list-disc pl-6 mt-2 text-sm">
                                ...
                                <li className="anim text-background/70 hover:text-background text-xs md:text-sm w-fit text-justify">
                                    <strong>Warranty</strong> the system remains stable during peak
                                    usage, is available 24/7, and keeps student data secure through
                ...
                <Template>
                    ...
                    <Section>
                        <h3 className="font-normal text-sm">Homework 2 – ITS Blackout Analysis</h3>
                        <Paragraph
                            text={
