                            ...
                            <table className="min-w-full border border-gray-300 text-xs">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="border px-4 py-2">
                                            Service, managed, systems, benefits, information,
                                            created, managed, used, support, enable, cover,
                                            exchanged, availability, reliability, accessibility,
                                            timeliness, accuracy, relevance, security, regulatory,
                                            requirements
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="border px-4 py-2">
                                            ...
                                            legal, environmental, influence, expectations, versions
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
